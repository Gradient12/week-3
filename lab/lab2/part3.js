...
var largeStationList = _.filter(data,function(bikeDock){
  return bikeDock[3]>20;
});
console.log(largeStationList);

var largeStationCount =_.countBy(data,function(bikeDock){
  return bikeDock[3]>20?'large':'small';
});
